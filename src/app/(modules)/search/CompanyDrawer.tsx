                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                                ...
                                <span className="rounded-pill bg-muted px-2 py-0.5 text-xs">{parseInt(companyData?.employee_size || '0').toLocaleString()} employees</span>
                    ...
                    {tab === 'overview' && (
                        <div className="space-y-6">
                            <div>
                                ...
                                {/* <Field label="DBA" value={companyData?.dba} /> */}
                                <Field label="NAICS" value={`${companyData?.naics_code}`} mono />
                                <Field label="SIC" value={`${companyData?.sic_code}`} mono />
                                <Field label="Employees" value={parseInt(companyData?.employee_size || '0').toLocaleString()} />
                                <Field label="Revenue" value={companyData ? `$${companyData.annual_revenue?.toLocaleString() || '—'}` : '—'} />
